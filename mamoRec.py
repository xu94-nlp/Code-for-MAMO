...
class MAMRec:
    def __init__(self, dataset='movielens'):
        ...
        """
        ---------------- Part I ----------------
        This part load features generated by pre-processing scripts, 
        and construct embeddings for later use.
        ----------------  P1 E  ----------------
        """
        ...
        """
        ---------------- Part II ---------------
        UserEmbedding and ItemEmbedding construct fully connected NN as a feature extractor.
        ---------------- P-II E  ---------------
        """
        # Embedding model
        ...
        """
        ---------------- Part III --------------
        RecMAM: RecMem contains mem_layer as its property, and return predict result.

        BASEModel: Load raw features from XXUserLoading and XXItemLoading, and convert them by UserEmbedding and ItemEmbedding. The output is given by Rec Module.
        This model uses a lot of auxiliary functions in utils.py in its own functions. BASEModel retrieves embeddings of items/users first (by XXUserLoading/XXItemLoading)
        and converts the retrieved embeddings by UserEmbedding/ItemEmbedding module (a fully connected NN).
        ...
        # cf. utils.py get_params. There's a count % 2 assertion in it. Be care about this difference.
        self.phi_u, self.phi_i, self.phi_r = self.model.get_weights()
        """
        --------------- Part IV ----------------
        FeatureMem stores parameters (transformative matrices) in UserEmbedding classes. n_k denotes the number of user prefernece 
        types, cf. (4) in the paper.
            - It stores n_k copies of parameters in the UserEmbedding class. 
        ----------------------------------------
        """
    ...
    def train_with_meta_optimization(self):
        for i in range(self.n_epoch):
            ...
            for u in self.train_users[:100]:
                ...
                # bias_term = personalized_mu in memory.
